...
public class Application {
    public static void main(String[] args) {
        ...
        Visitor area = new VisitorCalculateArea();
        Visitor perimeter = new VisitorCalculatePerimeter();
        Visitor draw = new VisitorDrawFigure();
        Visitor maximize = new VisitorMaximize();
